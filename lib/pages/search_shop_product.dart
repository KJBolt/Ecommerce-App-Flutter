...
class SearchShopProductPage extends StatefulWidget {
  final int shopId;
  const SearchShopProductPage({super.key, required this.shopId});

  @override
  State<SearchShopProductPage> createState() => _SearchShopProductPageState();
}

class _SearchShopProductPageState extends State<SearchShopProductPage> {
  ...
  Future<List<dynamic>?>fetchData(query) async {
    ...
    final url = '$apiEndpoint/products/search/${widget.shopId}';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: AppBar(
          ...
          elevation: 0.0,
          centerTitle: true,
          title: const Text("Search Product", style: TextStyle(fontSize: 18,fontWeight: FontWeight.w500)),
          leading: IconButton(
                      ...
                      itemBuilder: (context, index) {
                        return Container(
                          ...
                          child: ListTile(
                            ...
                            title: Text("${responseData[index]['name']}", style: const TextStyle(fontSize: 15, fontWeight: FontWeight.w600)),
                          ),
                        );
                      },
                    ),
